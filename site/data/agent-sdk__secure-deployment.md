...
Claude Code 包含多个安全功能来解决常见问题。有关完整详情，请参阅[安全文档#/page/security。

* **权限系统**：每个工具和 bash 命令都可以配置为允许、阻止或提示用户批准。使用 glob 模式创建规则，如"允许所有 npm 命令"或"阻止任何带有 sudo 的命令"。组织可以设置适用于所有用户的策略。请参阅[权限#/page/permissions。
...
* **Sandbox 模式**：Bash 命令可以在限制文件系统和网络访问的沙箱环境中运行。有关详情，请参阅[沙箱文档#/page/sandboxing。
...
* [Claude Code 安全文档#/page/security
* [托管 Agent SDK#/page/agent-sdk/hosting
* [处理权限#/page/agent-sdk/permissions
