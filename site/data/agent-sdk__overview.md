...
**准备好构建了吗？** 按照[快速入门#/page/agent-sdk/quickstart在几分钟内创建一个查找和修复 bug 的代理。
...
<Tabs>
  ...
  <Tab title="Hooks">
    ...
    **可用 hooks：** `PreToolUse`、`PostToolUse`、`Stop`、`SessionStart`、`SessionEnd`、`UserPromptSubmit` 等。
    ...
    [了解更多关于 hooks →#/page/agent-sdk/hooks
  </Tab>
  ...
  <Tab title="子代理">
    ...
    [了解更多关于子代理 →#/page/agent-sdk/subagents
  </Tab>
  ...
  <Tab title="权限">
    ...
    <Note>
      对于交互式批准提示和 `AskUserQuestion` 工具，请参阅[处理批准和用户输入#/page/agent-sdk/user-input。
    </Note>
    ...
    [了解更多关于权限 →#/page/agent-sdk/permissions
  </Tab>
  ...
  <Tab title="会话">
    ...
    [了解更多关于会话 →#/page/agent-sdk/sessions
  </Tab>
</Tabs>
...
| 功能                                                  | 描述                              | 位置                                |
| --------------------------------------------------- | ------------------------------- | --------------------------------- |
| [Skills#/page/agent-sdk/skills                   | Claude 自动使用或您使用 `/name` 调用的专门功能 | `.claude/skills/*/SKILL.md`       |
| [Commands#/page/agent-sdk/slash-commands         | 旧格式的自定义命令。为新的自定义命令使用 skills     | `.claude/commands/*.md`           |
| [Memory#/page/agent-sdk/modifying-system-prompts | 项目上下文和说明                        | `CLAUDE.md` 或 `.claude/CLAUDE.md` |
| [Plugins#/page/agent-sdk/plugins                 | 使用 skills、代理、hooks 和 MCP 服务器扩展  | 通过 `plugins` 选项编程                 |
