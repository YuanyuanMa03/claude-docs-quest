...
This reference page lists each key Claude Code reads from a settings file, plus the [short group of keys](#global-config-settings) it keeps in `~/.claude.json` instead. To pick a file, or check precedence, start with [Claude Code settings#/page/settings.
...
| :---------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------- | :---------------------- |
| [`advisorModel`](#advisormodel)                                                                       | Pick which model answers when Claude asks the [advisor tool#/page/advisor                                                                                                                                                   | Model and responses                | Any file                |
| [`agent`](#agent)                                                                                     | Start every session as a named [subagent#/page/sub-agents with its prompt, tools, and model                                                                                                                                 | Agents, sessions, and worktrees    | Any file                |
...
| [`allowAllClaudeAiMcps`](#allowallclaudeaimcps)                                                       | Load the [claude.ai connectors#/page/mcp Claude Code fetches itself alongside a deployed [`managed-mcp.json`](/docs/en/managed-mcp#exclusive-control-with-managed-mcp-json)                                                      | MCP                                | Managed                 |
...
| [`allowedHttpHookUrls`](#allowedhttphookurls)                                                         | Limit which URLs [HTTP hooks#/page/hooks can target                                                                                                                                                                         | Hooks and automation               | Any file                |
| [`allowedMcpServers`](#allowedmcpservers)                                                             | Allowlist which [MCP servers#/page/mcp people can use                                                                                                                                                                       | MCP                                | Any file                |
| [`allowManagedHooksOnly`](#allowmanagedhooksonly)                                                     | Run only the [hooks#/page/hooks your organization deploys                                                                                                                                                                   | Hooks and automation               | Managed                 |
| [`allowManagedMcpServersOnly`](#allowmanagedmcpserversonly)                                           | Make the managed [MCP#/page/mcp allowlist the only one that applies                                                                                                                                                         | MCP                                | Managed                 |
| [`allowManagedPermissionRulesOnly`](#allowmanagedpermissionrulesonly)                                 | Make [managed settings#/page/managed-settings the only settings source of [permission rules](/docs/en/permissions#managed-settings)                                                                                              | Permission settings                | Managed                 |
...
| [`attribution.sessionUrl`](#attribution-sessionurl)                                                   | Omit the claude.ai session link from [cloud#/page/claude-code-on-the-web and [Remote Control#/page/remote-control commits                                                                                                   | Git and attribution                | Any file                |
| [`autoCompactEnabled`](#autocompactenabled)                                                           | Turn [automatic compaction#/page/context-window off or on                                                                                                                                                                   | Memory and context                 | Any file                |
| [`autoCompactWindow`](#autocompactwindow)                                                             | Set how full the context gets before Claude Code [compacts#/page/context-window                                                                                                                                             | Memory and context                 | Any file                |
| [`autoConnectIde`](#autoconnectide)                                                                   | Connect to a running [VS Code#/page/vs-code or [JetBrains](/docs/en/jetbrains#from-external-terminals) IDE automatically from an external terminal                                                                               | Global config settings             | Global config           |
...
| [`axScreenReader`](#axscreenreader)                                                                   | Render [screen-reader friendly output#/page/accessibility                                                                                                                                                                   | Interface and terminal             | Any file                |
...
| [`blockedMarketplaces`](#blockedmarketplaces)                                                         | Block [plugin marketplace#/page/plugin-marketplaces sources for your organization                                                                                                                                           | Plugins and skills                 | Managed                 |
| [`browserExternalPageTools`](#browserexternalpagetools)                                               | Keep Claude's tools off external pages in the [desktop#/page/desktop Browser pane                                                                                                                                           | Tools                              | Managed                 |
...
| [`deniedMcpServers`](#deniedmcpservers)                                                               | Block specific [MCP servers#/page/mcp by URL, command, or name                                                                                                                                                              | MCP                                | Any file                |
...
| [`dialogExpiry`](#dialogexpiry)                                                                       | Set how long Claude Code waits for [Remote Control#/page/remote-control or an SDK host to answer a forwarded dialog before it cancels the dialog                                                                            | Interface and terminal             | User or managed         |
| [`diffTool`](#difftool)                                                                               | Choose whether Claude's proposed file changes open in the [VS Code#/page/vs-code or [JetBrains](/docs/en/jetbrains#features) diff viewer or stay in the terminal                                                                 | Global config settings             | Global config           |
| [`disableAgentView`](#disableagentview)                                                               | Turn off background agents and [agent view#/page/agent-view                                                                                                                                                                 | Agents, sessions, and worktrees    | Any file                |
| [`disableAllHooks`](#disableallhooks)                                                                 | Turn off [hooks#/page/hooks, a custom [status line#/page/statusline, and a custom [`@` file suggestion](/docs/en/interactive-mode#quick-commands) command at once                                                                | Hooks and automation               | Any file                |
| [`disableArtifact`](#disableartifact)                                                                 | Deprecated; use `enableArtifact` to turn the [Artifact tool#/page/artifacts off                                                                                                                                             | Remote, desktop, and notifications | Any file                |
...
| [`disableBrowserExternalNavigation`](#disablebrowserexternalnavigation)                               | Limit the [desktop#/page/desktop Browser pane to localhost for people and Claude                                                                                                                                            | Tools                              | Managed                 |
| [`disableBundledSkills`](#disablebundledskills)                                                       | Turn off the [skills](/docs/en/skills#bundled-skills) and [workflows#/page/workflows included with Claude Code                                                                                                                   | Plugins and skills                 | Any file                |
...
| [`disableCommandPluginSources`](#disablecommandpluginsources)                                         | Block [plugins#/page/plugins that install by running a marketplace-declared command                                                                                                                                         | Plugins and skills                 | Managed                 |
| [`disableDeepLinkRegistration`](#disabledeeplinkregistration)                                         | Stop Claude Code from registering the [`claude-cli://` handler#/page/deep-links                                                                                                                                             | Remote, desktop, and notifications | Any file                |
...
| [`disableMobileSimulatorTools`](#disablemobilesimulatortools)                                         | Block Claude's tools in the [desktop#/page/desktop iOS Simulator pane                                                                                                                                                       | Tools                              | Managed                 |
| [`disableRemoteControl`](#disableremotecontrol)                                                       | Turn off [Remote Control#/page/remote-control everywhere it can start                                                                                                                                                       | Remote, desktop, and notifications | Any file                |
| [`disableSideloadFlags`](#disablesideloadflags)                                                       | Reject the CLI flags that sideload [plugins#/page/plugins, [subagents#/page/sub-agents, and [MCP servers#/page/mcp                                                                                                          | Enterprise and managed settings    | Managed                 |
| [`disableSkillShellExecution`](#disableskillshellexecution)                                           | Stop [skills#/page/skills and custom commands from running inline shell                                                                                                                                                     | Plugins and skills                 | Any file                |
| [`disableWorkflows`](#disableworkflows)                                                               | Turn [dynamic workflows#/page/workflows off for everyone; use `enableWorkflows` for yourself                                                                                                                                | Hooks and automation               | Any file                |
...
| [`enableArtifact`](#enableartifact)                                                                   | Turn the [Artifact tool#/page/artifacts off with a `false` in any file; no file can turn it back on                                                                                                                         | Remote, desktop, and notifications | Any file                |
...
| [`enabledPlugins`](#enabledplugins)                                                                   | Turn individual [plugins#/page/plugins on or off per scope                                                                                                                                                                  | Plugins and skills                 | Any file                |
| [`enableWorkflows`](#enableworkflows)                                                                 | Turn [dynamic workflows#/page/workflows on or off against your plan's default                                                                                                                                               | Hooks and automation               | Any file                |
...
| [`extraKnownMarketplaces`](#extraknownmarketplaces)                                                   | Register [marketplaces#/page/plugin-marketplaces for a repository or an organization                                                                                                                                        | Plugins and skills                 | Any file                |
...
| [`fastMode`](#fastmode)                                                                               | Turn [fast mode#/page/fast-mode on for sessions where it's available                                                                                                                                                        | Model and responses                | Any file                |
| [`fastModePerSessionOptIn`](#fastmodepersessionoptin)                                                 | Require people to turn [fast mode#/page/fast-mode on each session                                                                                                                                                           | Model and responses                | Any file                |
...
| [`fileCheckpointingEnabled`](#filecheckpointingenabled)                                               | Turn off or on the file snapshots that [`/rewind`#/page/checkpointing restores                                                                                                                                              | Memory and context                 | Any file                |
...
| [`forceLoginMethod`](#forceloginmethod)                                                               | [Restrict login](/docs/en/authentication#restrict-login-to-your-organization) to claude.ai, Claude Console, or a [cloud gateway#/page/claude-apps-gateway                                                                        | Authentication and providers       | Any file                |
...
| [`forceRemoteSettingsRefresh`](#forceremotesettingsrefresh)                                           | Block startup until [server-managed settings#/page/server-managed-settings are freshly fetched                                                                                                                              | Enterprise and managed settings    | Managed                 |
...
| [`hooks`](#hooks)                                                                                     | Run your own commands as [hooks#/page/hooks at points in Claude Code's lifecycle                                                                                                                                            | Hooks and automation               | Any file                |
| [`httpHookAllowedEnvVars`](#httphookallowedenvvars)                                                   | Limit which env vars [HTTP hooks#/page/hooks can put in headers                                                                                                                                                             | Hooks and automation               | Any file                |
...
| [`outputStyle`](#outputstyle)                                                                         | Change Claude's role, tone, and output format with an [output style#/page/output-styles                                                                                                                                     | Model and responses                | Any file                |
| [`parentSettingsBehavior`](#parentsettingsbehavior)                                                   | Apply or drop restrictions an [SDK or IDE host](/docs/en/managed-settings#let-an-embedding-host-add-policy) passes when you deploy [managed settings#/page/managed-settings                                                      | Enterprise and managed settings    | Managed                 |
...
| [`permissions`](#permissions)                                                                         | Set allow, ask, and deny rules and the starting [permission mode#/page/permission-modes                                                                                                                                     | Permission settings                | Any file                |
...
| [`pluginConfigs`](#pluginconfigs)                                                                     | Store the answers you gave a [plugin#/page/plugins's configuration dialog                                                                                                                                                   | Plugins and skills                 | User or managed         |
...
| [`pluginTrustMessage`](#plugintrustmessage)                                                           | Add your own text to the [plugin#/page/plugins trust warning                                                                                                                                                                | Plugins and skills                 | Managed                 |
...
| [`processWrapper`](#processwrapper)                                                                   | Run Claude Code's background processes through a [corporate launcher#/page/corporate-launcher on macOS and Linux                                                                                                            | Agents, sessions, and worktrees    | User or managed         |
...
| [`remote.defaultEnvironmentId`](#remote-defaultenvironmentid)                                         | Pick the default [cloud environment#/page/cloud-environments for `claude --cloud`; a self-hosted `ccpool_` ID is read only from user and managed settings and `--settings`                                                  | Remote, desktop, and notifications | Any file                |
...
| [`sandbox`](#sandbox)                                                                                 | [Isolate Bash commands#/page/sandboxing from your filesystem and network on macOS, Linux, and WSL2                                                                                                                          | Sandbox settings                   | Any file                |
| [`sandbox.allowAppleEvents`](#sandbox-allowappleevents)                                               | Let [sandboxed#/page/sandboxing commands send Apple Events on macOS                                                                                                                                                         | Sandbox settings                   | User or managed         |
...
| [`sandbox.bwrapPath`](#sandbox-bwrappath)                                                             | Point the [sandbox#/page/sandboxing at a bubblewrap binary outside `PATH`                                                                                                                                                   | Sandbox settings                   | Managed                 |
...
| [`sandbox.enableWeakerNestedSandbox`](#sandbox-enableweakernestedsandbox)                             | Run the Linux [sandbox#/page/sandboxing inside an unprivileged container                                                                                                                                                    | Sandbox settings                   | Any file                |
...
| [`sandbox.excludedCommands`](#sandbox-excludedcommands)                                               | Name commands that always run outside the [sandbox#/page/sandboxing                                                                                                                                                         | Sandbox settings                   | Any file                |
| [`sandbox.failIfUnavailable`](#sandbox-failifunavailable)                                             | Refuse to start when the [sandbox#/page/sandboxing can't, instead of running unsandboxed                                                                                                                                    | Sandbox settings                   | Any file                |
...
| [`sandbox.filesystem.allowWrite`](#sandbox-filesystem-allowwrite)                                     | Add paths [sandboxed#/page/sandboxing commands can write to                                                                                                                                                                 | Sandbox settings                   | Any file                |
| [`sandbox.filesystem.denyRead`](#sandbox-filesystem-denyread)                                         | Block [sandboxed#/page/sandboxing commands from reading specific paths                                                                                                                                                      | Sandbox settings                   | Any file                |
| [`sandbox.filesystem.denyWrite`](#sandbox-filesystem-denywrite)                                       | Block [sandboxed#/page/sandboxing commands from writing to specific paths                                                                                                                                                   | Sandbox settings                   | Any file                |
...
| [`sandbox.network.allowAllUnixSockets`](#sandbox-network-allowallunixsockets)                         | Let [sandboxed#/page/sandboxing commands connect to every Unix socket                                                                                                                                                       | Sandbox settings                   | Any file                |
| [`sandbox.network.allowedDomains`](#sandbox-network-alloweddomains)                                   | Pre-allow domains so [sandboxed#/page/sandboxing commands don't prompt for them                                                                                                                                             | Sandbox settings                   | Any file                |
| [`sandbox.network.allowLocalBinding`](#sandbox-network-allowlocalbinding)                             | Let [sandboxed#/page/sandboxing commands bind to localhost ports on macOS                                                                                                                                                   | Sandbox settings                   | Any file                |
| [`sandbox.network.allowMachLookup`](#sandbox-network-allowmachlookup)                                 | Let macOS [sandboxed#/page/sandboxing tools like the iOS Simulator or Playwright reach their XPC services                                                                                                                   | Sandbox settings                   | Any file                |
...
| [`sandbox.network.allowUnixSockets`](#sandbox-network-allowunixsockets)                               | List Unix socket paths [sandboxed#/page/sandboxing commands can use on macOS                                                                                                                                                | Sandbox settings                   | Any file                |
| [`sandbox.network.deniedDomains`](#sandbox-network-denieddomains)                                     | Block domains for [sandboxed#/page/sandboxing commands, even inside an allowed wildcard                                                                                                                                     | Sandbox settings                   | Any file                |
...
| [`sandbox.ripgrep`](#sandbox-ripgrep)                                                                 | Use your own ripgrep binary inside the [sandbox#/page/sandboxing                                                                                                                                                            | Sandbox settings                   | User or managed         |
| [`sandbox.socatPath`](#sandbox-socatpath)                                                             | Point the [sandbox#/page/sandboxing proxy at a `socat` binary outside `PATH`                                                                                                                                                | Sandbox settings                   | Managed                 |
...
| [`statusLine`](#statusline)                                                                           | Run your own command to render a [status line#/page/statusline below the prompt                                                                                                                                             | Interface and terminal             | Any file                |
| [`strictKnownMarketplaces`](#strictknownmarketplaces)                                                 | Allowlist the [marketplace#/page/plugin-marketplaces sources users can add and install from                                                                                                                                 | Plugins and skills                 | Managed                 |
| [`strictPluginOnlyCustomization`](#strictpluginonlycustomization)                                     | Block [skills#/page/skills, [agents#/page/sub-agents, [hooks#/page/hooks, and [MCP servers#/page/mcp from user and project sources                                                                                          | Plugins and skills                 | Managed                 |
| [`strictPluginOnlyCustomization.agents`](#strictpluginonlycustomization-agents)                       | Lock [agents#/page/sub-agents to plugin and managed sources                                                                                                                                                                 | Plugins and skills                 | Managed                 |
| [`strictPluginOnlyCustomization.hooks`](#strictpluginonlycustomization-hooks)                         | Lock [hooks#/page/hooks to plugin and managed sources                                                                                                                                                                       | Plugins and skills                 | Managed                 |
| [`strictPluginOnlyCustomization.mcp`](#strictpluginonlycustomization-mcp)                             | Lock [MCP servers#/page/mcp to plugin and managed sources                                                                                                                                                                   | Plugins and skills                 | Managed                 |
| [`strictPluginOnlyCustomization.skills`](#strictpluginonlycustomization-skills)                       | Lock [skills#/page/skills to plugin and managed sources                                                                                                                                                                     | Plugins and skills                 | Managed                 |
...
| [`subagentStatusLine`](#subagentstatusline)                                                           | Rewrite rows in the [subagent#/page/sub-agents task display with your own command                                                                                                                                           | Interface and terminal             | Any file                |
...
| [`tui`](#tui)                                                                                         | Choose the [fullscreen#/page/fullscreen or classic terminal renderer                                                                                                                                                        | Interface and terminal             | Any file                |
...
| [`voice`](#voice)                                                                                     | Turn on [voice dictation#/page/voice-dictation and pick hold or tap mode                                                                                                                                                    | Interface and terminal             | Any file                |
| [`voiceEnabled`](#voiceenabled)                                                                       | Turn on [voice dictation#/page/voice-dictation with the older single-key form                                                                                                                                               | Interface and terminal             | Any file                |
...
| [`workflowKeywordTriggerEnabled`](#workflowkeywordtriggerenabled)                                     | Let the word `ultracode` in a prompt start a [workflow#/page/workflows; set `false` to type it without starting one                                                                                                         | Hooks and automation               | Any file                |
| [`workflowSizeGuideline`](#workflowsizeguideline)                                                     | Set the agent count Claude aims for in [dynamic workflows#/page/workflows                                                                                                                                                   | Hooks and automation               | Any file                |
| [`worktree`](#worktree)                                                                               | Configure how Claude Code creates git [worktrees#/page/worktrees                                                                                                                                                            | Agents, sessions, and worktrees    | Any file                |
| [`worktree.baseRef`](#worktree-baseref)                                                               | Branch new [worktrees#/page/worktrees from the remote default branch or your local HEAD                                                                                                                                     | Agents, sessions, and worktrees    | Any file                |
| [`worktree.bgIsolation`](#worktree-bgisolation)                                                       | Let background sessions edit the working copy without a [worktree#/page/worktrees                                                                                                                                           | Agents, sessions, and worktrees    | Any file                |
| [`worktree.sparsePaths`](#worktree-sparsepaths)                                                       | Check out only the directories you need in each [worktree#/page/worktrees                                                                                                                                                   | Agents, sessions, and worktrees    | Any file                |
| [`worktree.symlinkDirectories`](#worktree-symlinkdirectories)                                         | Symlink large directories into each [worktree#/page/worktrees instead of duplicating them                                                                                                                                   | Agents, sessions, and worktrees    | Any file                |
| [`wslInheritsWindowsSettings`](#wslinheritswindowssettings)                                           | Have WSL read [managed settings#/page/managed-settings from the Windows policy chain                                                                                                                                        | Enterprise and managed settings    | Managed                 |

## Model and responses

Choose which models Claude Code uses and how it responds. For how these settings interact with the `/model` command and environment variables, see [Model configuration#/page/model-config.

### `advisorModel`

Pick which model answers when Claude calls the server-side [advisor tool#/page/advisor. Unset it to turn the advisor off. The advisor must be at least as capable as your main model; when it isn't, Claude Code sends requests without the advisor. See [Choose an advisor model](/docs/en/advisor#choose-an-advisor-model).
...
* **Per-session overrides**: `--advisor` takes precedence over this key for one session. [`CLAUDE_CODE_DISABLE_ADVISOR_TOOL`#/page/env-vars turns the advisor off, and this key can't turn it back on
...
* **Per-session overrides**: [`MAX_THINKING_TOKENS`#/page/env-vars takes precedence over this key for one session: `0` turns thinking off, under the same model and provider limits as `false`, and a positive value turns thinking on even when this key is `false`. On adaptive-reasoning models the number itself is ignored
...
Restrict which models people can select for the main session, [subagents#/page/sub-agents, [skills#/page/skills, and the [advisor#/page/advisor. A managed list constrains `/model`, `--model`, and the `model` key in a developer's own files; a model outside it can't be selected. On its own this doesn't touch the Default option; pair it with [`enforceAvailableModels`](#enforceavailablemodels) for that.
...
* **Default**: unset
* **Per-session overrides**: `--effort` takes precedence over this key for one session, and [`CLAUDE_CODE_EFFORT_LEVEL`#/page/env-vars takes precedence over both
...
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_FAST_MODE`#/page/env-vars turns fast mode off for one session, and this key can't turn it back on
...
* **Per-session overrides**: `--model` takes precedence over [`ANTHROPIC_MODEL`#/page/env-vars, and both take precedence over this key for one session, including over a managed `model`; an [`availableModels`](#availablemodels) list still applies to the pick
...
Select an [output style#/page/output-styles by name. An output style is a saved set of instructions that Claude Code adds to the system prompt to change Claude's role, tone, and output format, such as the built-in Explanatory and Learning styles or one you wrote yourself.
...
* **Per-session overrides**: [`FORCE_PROMPT_CACHING_5M`#/page/env-vars takes precedence over everything else, then [`CLAUDE_CODE_PROMPT_CACHE_TTL`#/page/env-vars, then this key, and last [`ENABLE_PROMPT_CACHING_1H`#/page/env-vars
...
Choose how long the [prompt cache#/page/prompt-caching holds the requests Claude Code makes outside the main conversation. This key applies to [subagents#/page/sub-agents, [workflows#/page/workflows, and Claude Code's own background and helper requests, such as compaction and session titles. The one-hour lifetime keeps the cache warm across longer breaks, and the API [bills each cache write at a higher rate](https://platform.claude.com/docs/en/build-with-claude/prompt-caching#pricing) than at the five-minute lifetime. Requires Claude Code v2.1.242 or later.
...
* **Per-session overrides**: [`FORCE_PROMPT_CACHING_5M`#/page/env-vars takes precedence over everything else, then [`CLAUDE_CODE_SUBAGENT_PROMPT_CACHE_TTL`#/page/env-vars, then this key, then [`ENABLE_PROMPT_CACHING_1H`#/page/env-vars, which asks for the one-hour lifetime on every request. For where a subagent's own frontmatter value ranks, see [Choose the TTL yourself](/docs/en/prompt-caching#choose-the-ttl-yourself)
...
Start sessions with [ultracode](/docs/en/workflows#let-claude-decide-with-ultracode) on. With it on, Claude plans a workflow for each substantive task instead of waiting for you to ask. Claude plans workflows only when [dynamic workflows#/page/workflows are enabled for you and your model supports `xhigh` effort. Either way, `ultracode: true` runs the session at `xhigh` effort. Claude Code reads this key but never writes it: `/effort ultracode` turns ultracode on for the current session only.
...
Decide what Claude can do without asking, which permission mode a session starts in, and what auto mode's classifier allows. For rule syntax and the permission model, see [Configure permissions#/page/permissions.
...
When more than one of those files sets the same array, Claude Code concatenates the entries. For the rule format and how each array is applied, see [Configure auto mode#/page/auto-mode-config.
...
* **Scope**: [`Any file`](#scopes). Most useful in [managed settings#/page/managed-settings, where users can't override it. Also accepted under `permissions` as `permissions.disableAutoMode`.
...
Control which tools Claude can use without asking, which ones always prompt, and which ones are blocked, and set the [permission mode#/page/permission-modes a session starts in. Every `permissions.*` key below nests under this object.
...
* **Scope**: [`Any file`](#scopes). Typically set in [managed settings#/page/managed-settings to enforce organizational policy.
* **Type**: the string `"disable"`
* **Default**: unset
...
Isolate the commands Claude runs from your filesystem, your network, and your credentials. For how sandboxing works and platform requirements, see [Sandboxing#/page/sandboxing.

### `sandbox`

Isolate the Bash commands Claude runs from your filesystem and network with [sandboxing#/page/sandboxing. Turn the sandbox on with `enabled`, then narrow or widen what sandboxed commands can touch with the `filesystem`, `network`, and `credentials` sub-objects. The sandbox runs on macOS, Linux, and WSL2.
...
Turn on [sandboxing#/page/sandboxing for Bash commands. When you pick a mode in the `/sandbox` panel, Claude Code writes this key to `.claude/settings.local.json` for the current project; set it in `~/.claude/settings.json` to sandbox every project.
...
* **Default**: unset, so the sandbox uses the same ripgrep binary as Claude Code. That is the bundled binary unless you set [`USE_BUILTIN_RIPGREP`#/page/env-vars to `0`
...
Control what Claude Code loads into context, how it compacts, and where it keeps memory and plans. See [Manage context#/page/context-window and [Memory#/page/memory.
...
* **Default**: `true`
* **Per-session overrides**: [`DISABLE_AUTO_COMPACT`#/page/env-vars turns auto-compact off for one session; whichever of the two turns it off, the other can't turn it back on
...
* **Per-session overrides**: [`--autocompact`](/docs/en/cli-reference#cli-flags) takes precedence over this key for one session, and [`CLAUDE_CODE_AUTO_COMPACT_WINDOW`#/page/env-vars takes precedence over both
...
* **Default**: `true`
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_AUTO_MEMORY`#/page/env-vars takes precedence over this key for one session, in either direction
...
When you set this key, Claude Code ignores the [`BASH_MAX_OUTPUT_LENGTH`#/page/env-vars environment variable.
...
Set environment variables for every session and for the subprocesses Claude Code starts from it. Any variable in the [environment variables reference#/page/env-vars can go here, which is how you apply one to every session or roll it out to your team.
...
Have Claude Code snapshot files before each edit so [`/rewind`#/page/checkpointing can restore them. Appears in `/config` as **Rewind code (checkpoints)**, and toggling it there writes this key to your user settings.
...
* **Default**: `true`
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_FILE_CHECKPOINTING`#/page/env-vars turns checkpointing off for one session; whichever of the two turns it off, the other can't turn it back on
...
In a `-p` run or an Agent SDK session, Claude Code ignores this key. The SDK turns checkpointing on with its `enableFileCheckpointing` option, and a bare `-p` run needs `CLAUDE_CODE_ENABLE_SDK_FILE_CHECKPOINTING=true`. See [File checkpointing in the Agent SDK#/page/agent-sdk/file-checkpointing.
...
When you set this key, Claude Code ignores the [`TASK_MAX_OUTPUT_LENGTH`#/page/env-vars environment variable.

## Interface and terminal

Change how Claude Code looks and behaves in your terminal: theme, editor mode, status line, spinner, notifications inside the session, and accessibility. See [Terminal configuration#/page/terminal-config.

### `askUserQuestionTimeout`

Let an unanswered [`AskUserQuestion`#/page/tools-reference dialog auto-continue after a period of idle time, submitting whatever options you had already selected. Set it when you step away and want Claude to continue without you. With the default, questions wait until you answer them. Requires Claude Code v2.1.200 or later.

* **Scope**: [`User or managed`](#scopes)
* **Type**: string, one of `"60s"`, `"5m"`, `"10m"`, or `"never"`
* **Default**: `"never"`
* **Per-session overrides**: [`CLAUDE_AFK_TIMEOUT_MS`#/page/env-vars takes precedence over this key for one session
...
Follow new output to the bottom of the conversation in [fullscreen rendering#/page/fullscreen. Turn it off to stay where you scrolled while Claude keeps working; permission prompts still scroll into view.
...
Render screen-reader friendly output: flat text without decorative borders or animations. Screen-reader mode uses the classic renderer, so the `tui` setting has no effect while it is active; attached [background sessions#/page/agent-view still render fullscreen. Requires Claude Code v2.1.181 or later.
...
* **Per-session overrides**: [`--ax-screen-reader`](/docs/en/cli-reference#cli-flags) takes precedence over [`CLAUDE_AX_SCREEN_READER`#/page/env-vars, and both take precedence over this key for one session
...
* **Default**: `"5m"`
* **Per-session overrides**: [`CLAUDE_CODE_USER_DIALOG_TIMEOUT_MS`#/page/env-vars takes precedence over this key for one session
...
Claude Code runs the command with the same environment variables as [hooks#/page/hooks, including `CLAUDE_PROJECT_DIR`, and stops waiting after five seconds. The command receives JSON on stdin with a `query` field holding what you've typed so far:
...
Footer badges render alongside a [custom status line#/page/statusline when one is configured; neither replaces the other. Use a status line for a script-driven row that computes its own content from session data, and footer badges to turn IDs from the conversation into links without a script.
...
* **Default**: `true`
* **Per-session overrides**: [`CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION`#/page/env-vars takes precedence over this key for one session
...
Prompt suggestions need a claude.ai or Console account with telemetry on. On Amazon Bedrock, Google Cloud's Agent Platform, and Microsoft Foundry, or with telemetry turned off, such as by [`DISABLE_TELEMETRY`#/page/env-vars, this key has no effect and only `CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION=1` turns them on.
...
Run your own command to render a [status line#/page/statusline below the prompt with context such as the model, cost, or git branch. Optional fields adjust spacing, add periodic re-runs, and hide the built-in vim mode indicator when your script renders `vim.mode` itself.
...
To stop Claude Code from updating the terminal title at all, set [`CLAUDE_CODE_DISABLE_TERMINAL_TITLE`#/page/env-vars to `1` instead.
...
Choose the terminal UI renderer. Use `"fullscreen"` for the flicker-free [alt-screen renderer#/page/fullscreen with virtualized scrollback, or `"default"` for the classic main-screen renderer. Running `/tui fullscreen` or `/tui default` writes this key for you.
...
* **Per-session overrides**: [`CLAUDE_CODE_NO_FLICKER`#/page/env-vars and [`CLAUDE_CODE_DISABLE_ALTERNATE_SCREEN`#/page/env-vars take precedence over this key for one session: `CLAUDE_CODE_NO_FLICKER=1` turns fullscreen on, and `CLAUDE_CODE_NO_FLICKER=0` or `CLAUDE_CODE_DISABLE_ALTERNATE_SCREEN=1` turns it off; when both are set, Claude Code turns it off
...
Under tmux `-CC` or over SSH to Windows, Claude Code keeps the classic renderer unless you set `CLAUDE_CODE_NO_FLICKER=1`. Background sessions opened from [agent view#/page/agent-view always use the fullscreen renderer regardless of this setting.
...
Turn on [voice dictation#/page/voice-dictation and choose how the dictation key behaves. Claude Code writes this object for you when you run `/voice`.
...
* **Default**: `true`
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_GIT_INSTRUCTIONS`#/page/env-vars takes precedence over this key for one session
...
* **Default**: unset, so Claude Code adds `Co-Authored-By: <name> <noreply@anthropic.com>`. The name is the session's active model, such as `Claude Sonnet 5`.
  ...
  * When it can't match the model ID to any Claude model, such as a third-party model served through a custom [`ANTHROPIC_BASE_URL`#/page/env-vars, it writes `Claude Code`.
...
Choose whether Claude Code appends the claude.ai session link when it commits or opens a pull request from a [cloud#/page/claude-code-on-the-web or [Remote Control#/page/remote-control session. Claude Code adds the link as a `Claude-Session` trailer on commits and as a link in pull request descriptions. Set it to `false` to omit the link.
...
Register hooks, restrict which hooks run, and control workflows. For hook events and payloads, see the [hooks reference#/page/hooks.
...
* **Managed and SDK hooks run**: hooks from managed settings and hooks the [Agent SDK#/page/agent-sdk/overview registers in process
...
* **Status line and file suggestion narrow to managed settings**: Claude Code reads [`statusLine`#/page/statusline, [`fileSuggestion`](#filesuggestion), and [`subagentStatusLine`](/docs/en/statusline#subagent-status-lines) from managed settings only, following the [status line and file suggestion gates](#status-line-and-file-suggestion-gates)

The [`/goal`#/page/goal command can't run while this key is set, because it depends on hooks.

### `disableAllHooks`

Turn off [hooks](/docs/en/hooks#disable-or-remove-hooks), any custom [status line#/page/statusline, and any custom [file suggestion](#filesuggestion) command. Use it to turn all of these off temporarily without deleting them from your settings.
...
* **In managed settings**: Claude Code disables every configured hook, including managed ones, and keeps running the hooks the [Agent SDK#/page/agent-sdk/overview registers in process
...
The [`/goal`#/page/goal command can't run while hooks are disabled, and the `/hooks` menu shows a notice instead of your hooks.
...
* **Default**: `false`
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_WORKFLOWS`#/page/env-vars turns workflows off for one session; whichever of the two turns them off, the other can't turn them back on
...
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_WORKFLOWS`#/page/env-vars turns workflows off for one session, and `true` here can't turn them back on while it's set
...
Run your own commands, prompts, agents, HTTP requests, or MCP tools as [hooks#/page/hooks at points in Claude Code's lifecycle, such as before a tool call or when a session starts; the [hooks reference](/docs/en/hooks#hook-events) lists every event, its payload, and its exit codes. Each event maps to a list of matcher groups, and each group lists the handlers to run when the matcher applies.
...
Enable plugins, register marketplaces, restrict which plugin sources an organization allows, and control which skills load. For installing and building plugins, see [Plugins#/page/plugins.

### `disableBundledSkills`

Turn off the [skills#/page/skills and workflows included with Claude Code. Claude Code removes bundled skills and workflows entirely, while built-in commands such as `/init` stay typable but are hidden from the model.
...
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_BUNDLED_SKILLS`#/page/env-vars set to `1` turns bundled skills off for one session; whichever of the two turns them off, the other can't turn them back on
...
Skills from plugins, `.claude/skills/`, and `.claude/commands/` are unaffected. `/doctor` stays typable like the built-in commands; to hide it, set [`DISABLE_DOCTOR_COMMAND`#/page/env-vars instead.
...
Choose which [channel#/page/channels plugins can push messages into sessions in your organization. When you set it, Claude Code uses your list in place of the default Anthropic allowlist; each entry names a plugin and the marketplace it comes from.
...
Allow [channels#/page/channels for your organization. On claude.ai Team and Enterprise plans, Claude Code blocks channels until you set this to `true`. For [Anthropic Console](/docs/en/authentication#claude-console-authentication) accounts that authenticate with an API key, channels are allowed by default. If your organization deploys managed settings, Claude Code blocks channels on those accounts too until you set this key to `true`.
...
Lock the `mcp` surface. Claude Code stops loading MCP servers from `~/.claude.json` and `.mcp.json`, and keeps loading plugin MCP servers and [`managed-mcp.json`#/page/managed-mcp servers.
...
Control which MCP servers Claude Code connects to and which an organization allows. See [Connect to external tools with MCP#/page/mcp and [Managed MCP configuration#/page/managed-mcp.
...
[`allowedMcpServers`](#allowedmcpservers) and [`deniedMcpServers`](#deniedmcpservers) still apply to the connectors this key loads. Connectors delivered to a [cloud session#/page/claude-code-on-the-web whose host carries a `managed-mcp.json`, such as a self-hosted runner, stay suppressed. See [Allow claude.ai connectors alongside the managed set](/docs/en/managed-mcp#allow-claude-ai-connectors-alongside-the-managed-set).
...
* **Per-session overrides**: [`ENABLE_CLAUDEAI_MCP_SERVERS`#/page/env-vars set to `false` turns connectors off for one session; whichever of the two turns them off, the other can't turn them back on
...
Set the default agent, control teammates and cross-session messaging, and configure worktrees. See [Subagents#/page/sub-agents and [Worktrees#/page/worktrees.
...
When the unrecognized value is in [managed settings#/page/managed-settings, Claude Code instead treats it as `refuse` until an administrator fixes it. Before v2.1.248, Claude Code ignored an unrecognized value without warning.

### `disableAgentView`

Turn off [background agents and agent view#/page/agent-view: `claude agents`, `--bg`, `/background`, and the on-demand supervisor. Set it in [managed settings#/page/managed-settings to enforce it for an organization.
...
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_AGENT_VIEW`#/page/env-vars turns agent view off for one session; whichever of the two turns it off, the other can't turn it back on
...
On macOS and Linux, place a corporate launcher command in front of the [background processes Claude Code starts](/docs/en/corporate-launcher#what-the-launcher-covers). Claude Code runs the launcher with its own command line appended, so the launcher must exec into Claude Code; see [Run Claude Code behind a corporate launcher#/page/corporate-launcher for the launcher contract. Requires Claude Code v2.1.210 or later.
...
* **Per-session overrides**: [`CLAUDE_CODE_PROCESS_WRAPPER`#/page/env-vars takes precedence over this key for one session
...
Choose where Claude Code shows [agent team#/page/agent-teams teammates: inside your main terminal pane, or in split panes when your terminal supports them. See [Choose a display mode](/docs/en/agent-teams#choose-a-display-mode).
...
Configure how Claude Code creates and manages [git worktrees#/page/worktrees for `--worktree`, the `EnterWorktree` tool, and isolated subagents and background sessions.
...
Configure Remote Control, cloud environments, the desktop app, and the notifications Claude Code sends when it needs you. See [Remote Control#/page/remote-control.

### `agentPushNotifEnabled`

Allow Claude to send a push notification to your phone when it decides one is worth sending, for example when a long task finishes. Claude Code syncs this choice to your account, and pushes arrive while [Remote Control#/page/remote-control is connected. Appears in `/config` as **Push when Claude decides**.
...
* **Per-session overrides**: [`CLAUDE_CODE_ENABLE_AWAY_SUMMARY`#/page/env-vars takes precedence over this key for one session, in either direction
...
Use [`enableArtifact`](#enableartifact) instead to turn off the [Artifact#/page/artifacts tool, which publishes session output as a private web page on claude.ai. When you turn the **Artifacts** row off in `/config`, Claude Code writes `enableArtifact` to your user settings and clears this key.
...
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_ARTIFACT`#/page/env-vars set to `1` turns the tool off for one session
...
Turn off [Remote Control#/page/remote-control: Claude Code then refuses `claude remote-control`, the `--remote-control` flag, auto-start, and the in-session toggle, and reports that your organization's policy disabled it. Place it in [managed settings#/page/managed-settings for per-device MDM enforcement.
...
Turn off the [Artifact#/page/artifacts tool, which publishes session output as a private web page on claude.ai. When you turn the **Artifacts** row off in `/config`, Claude Code writes this key to your user settings, so you don't usually edit it by hand. Requires Claude Code v2.1.196 or later.
...
* **Type**: Boolean
  ...
  * `true`: the same as leaving the key unset, because it never overrides a `false` from another file, from [`CLAUDE_CODE_DISABLE_ARTIFACT`#/page/env-vars, or from your organization's [admin setting](/docs/en/artifacts#manage-artifacts-for-your-organization)
* **Default**: unset, so the tool follows your account's [availability](/docs/en/artifacts#availability)
...
Get a push notification on your phone when a permission prompt or question is waiting for your input. Claude Code sends these only while [Remote Control#/page/remote-control is connected. Appears in `/config` as **Push when actions required**.
...
Pick the default [cloud environment#/page/cloud-environments for cloud sessions you create from the CLI, such as with `claude --cloud`. Claude Code writes this key to your user settings when you pick an environment with [`/remote-env`](/docs/en/cloud-environments#select-an-environment-from-the-cli).
...
Supply credentials through helper scripts and, for organizations, force a login method or organization. See [Authentication#/page/authentication.
...
* After the cache lifetime, five minutes by default or the interval you set with [`CLAUDE_CODE_API_KEY_HELPER_TTL_MS`#/page/env-vars.
* When a request to the Anthropic API, directly or through an [LLM gateway#/page/llm-gateway, fails with `401` or `403`.
...
Run your own command, such as `aws sso login`, to refresh the credentials in your `.aws` directory when the ones Claude Code has for [Amazon Bedrock#/page/amazon-bedrock stop working. Claude Code checks the current credentials against STS first and runs the command only when that check fails, then reads the refreshed `.aws` directory.
...
Run your own command to refresh Google Cloud Application Default Credentials when Claude Code finds they've expired or can't be loaded, so [Google Cloud's Agent Platform#/page/google-vertex-ai requests keep working without you re-authenticating by hand.
...
Set the refresh interval with [`CLAUDE_CODE_OTEL_HEADERS_HELPER_DEBOUNCE_MS`#/page/env-vars. See [Dynamic headers](/docs/en/monitoring-usage#dynamic-headers) for the script requirements and where Claude Code reports a failing helper.
...
Turn off specific tools in the [Claude Code desktop app#/page/desktop. The terminal CLI ignores these keys. For the tools themselves, see [Tools available to Claude#/page/tools-reference.
...
* **Default**: `"notify"`
* **Per-session overrides**: [`CLAUDE_CODE_SEND_FEEDBACK`#/page/env-vars set to `0` turns the feature off for one session
...
* **Per-session overrides**: [`CLAUDE_CODE_DISABLE_FEEDBACK_SURVEY`#/page/env-vars set to `1` turns the survey off for one session whatever rate this key sets
...
Keys an organization uses to compute, refresh, and combine managed settings. See [Set up managed settings#/page/admin-setup.

### `disableSideloadFlags`

Reject the `--plugin-dir`, `--plugin-url`, `--agents`, and `--mcp-config` CLI flags at startup, which users could otherwise pass to bypass [`strictKnownMarketplaces`](#strictknownmarketplaces) for a single run. Claude Code exits with an error naming the rejected flags, and applies the same check to surfaces that start the CLI with these flags internally, currently [Cowork#/page/desktop local sessions in the desktop app. In [cloud sessions#/page/claude-code-on-the-web, Claude Code drops the MCP servers the server delivered through `--mcp-config`, other than in-process `type: "sdk"` entries, and starts the session. Requires Claude Code v2.1.193 or later.
...
Block CLI startup until Claude Code has freshly fetched [server-managed settings#/page/server-managed-settings. If the fetch fails, Claude Code exits instead of continuing with cached or no settings. Set it when your environment can't accept even a brief window in which a session runs without its managed policy.
...
When the startup run fails, Claude Code prints the reason and refuses to start. After a non-zero exit or a timeout, the message includes the helper's stderr. The refusal covers interactive sessions, `claude -p`, Agent SDK sessions, [background sessions#/page/agent-view, and most subcommands.

The refusal is deliberate, so a helper that needs outage resilience should serve from its own cache and exit `0`.

When a background refresh fails, Claude Code keeps the last successful policy in effect. Claude Code runs each refresh under the same `timeoutMs` and failure rules as the startup run. With `--debug`, Claude Code writes the helper's stderr from every run to the [debug log#/page/debug-your-config.
...
* **Default**: `false`
* **Per-session overrides**: [`CLAUDE_CODE_AUTO_CONNECT_IDE`#/page/env-vars takes precedence over this key for one session, in either direction
...
* **Default**: `true`
* **Per-session overrides**: [`CLAUDE_CODE_IDE_SKIP_AUTO_INSTALL`#/page/env-vars set to `1` skips the install for one session even when this key is `true`
...
* [Configure permissions#/page/permissions: rule syntax, permission modes, and workspace trust
* [Environment variables#/page/env-vars: every `CLAUDE_*`, `ANTHROPIC_*`, and provider variable Claude Code reads
* [Tools available to Claude#/page/tools-reference: the built-in tools and which need approval
* [Example settings files#/page/settings-example: a personal file, a team file, and an organization's managed file
* [Set up managed settings#/page/admin-setup: how organizations decide what to enforce
* [Deploy managed settings#/page/managed-settings: delivery mechanisms, precedence within the managed tier, and invalid entries in managed settings
* [Debug your configuration#/page/debug-your-config: `claude doctor` and the Settings Error dialog
