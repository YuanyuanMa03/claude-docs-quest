...
<Steps>
  <Step title="安装 Claude Code CLI">
    如果您还没有安装 CLI，请按照[快速入门#/page/quickstart进行安装。当 `claude` 不在您的 PATH 中时，插件会显示"无法启动 Claude Code"通知。
  </Step>
...
如需 IDE 外的 Claude Code 安装或登录问题，请参阅[故障排除安装和登录#/page/troubleshoot-install。
