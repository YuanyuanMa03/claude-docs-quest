...
<Note>
  **文档变更：** Agent SDK 文档已从 Claude Code 文档移至 API 指南下的专门 [Agent SDK#/page/agent-sdk/overview 部分。Claude Code 文档现在专注于 CLI 工具和自动化功能。
</Note>
...
* 探索 [Agent SDK 概述#/page/agent-sdk/overview 以了解可用功能
* 查看 [TypeScript SDK 参考#/page/agent-sdk/typescript 以获取详细的 API 文档
* 查看 [Python SDK 参考#/page/agent-sdk/python 以获取 Python 特定文档
* 了解 [自定义工具#/page/agent-sdk/custom-tools 和 [MCP 集成#/page/agent-sdk/mcp
