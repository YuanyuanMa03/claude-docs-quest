...
<Warning>
  ...
  要迁移，请使用 [`query()` API#/page/agent-sdk/typescript 和它接受的 [session 选项#/page/agent-sdk/sessions。为多轮对话传递 `AsyncIterable<SDKUserMessage>`，或使用 `options.resume` 继续已保存的会话。如果您在 Agent SDK 0.2.x 或更早版本上维护代码，此页面保留供参考。
</Warning>
...
V2 session API 不支持所有 V1 功能。以下功能需要使用 [V1 SDK#/page/agent-sdk/typescript：
...
* [TypeScript SDK 参考（V1）#/page/agent-sdk/typescript - 完整的 V1 SDK 文档
