...
* [计算机使用#/page/computer-use：当任务无法在浏览器中完成时控制本机 macOS 应用
* [在 VS Code 中使用 Claude Code](/docs/zh-CN/vs-code#automate-browser-tasks-with-chrome)：VS Code 扩展程序中的浏览器自动化
* [CLI 参考#/page/cli-reference：命令行标志，包括 `--chrome`
* [常见工作流#/page/common-workflows：更多使用 Claude Code 的方式
* [数据和隐私#/page/data-usage：Claude Code 如何处理您的数据
