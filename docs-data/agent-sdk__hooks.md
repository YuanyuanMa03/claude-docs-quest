...
* [Claude Code hooks 参考#/page/hooks：完整的 JSON 输入/输出架构、事件文档和匹配器模式
* [Claude Code hooks 指南#/page/hooks-guide：shell 命令 hook 示例和演练
* [TypeScript SDK 参考#/page/agent-sdk/typescript：hook 类型、输入/输出定义和配置选项
* [Python SDK 参考#/page/agent-sdk/python：hook 类型、输入/输出定义和配置选项
* [权限#/page/agent-sdk/permissions：控制您的代理可以做什么
* [自定义工具#/page/agent-sdk/custom-tools：构建工具以扩展代理功能
