...
此页面适用于marketplace运营商和企业管理员。如果您想要安装插件，请参阅[发现和安装插件#/page/discover-plugins。
...
有关`pluginSuggestionMarketplaces`和[`extraKnownMarketplaces`](/docs/zh-CN/settings#extraknownmarketplaces)的完整配置详情，请参阅[设置参考#/page/settings。
...
* [创建和分发插件marketplace#/page/plugin-marketplaces：构建托管您的插件的marketplace
* [从您的CLI推荐您的插件#/page/plugin-hints：从您自己的CLI而不是Claude Code的会话信号提示用户
* [设置#/page/settings：`pluginSuggestionMarketplaces`和`extraKnownMarketplaces`的完整参考
