...
* [`deleteSession()`#/page/agent-sdk/typescript
* [`forkSession()`#/page/agent-sdk/typescript
* [`listSubagents()`#/page/agent-sdk/typescript
* [`getSubagentMessages()`#/page/agent-sdk/typescript

<h2 id="related-resources">
  相关资源
</h2>

* [使用会话#/page/agent-sdk/sessions：在没有自定义存储的情况下继续、恢复和分叉
* [托管 SDK#/page/agent-sdk/hosting：多主机环境的部署模式
