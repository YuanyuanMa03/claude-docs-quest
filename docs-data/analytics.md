...
对于每个用户的令牌计数和成本估计，请配置 [OpenTelemetry 导出#/page/monitoring-usage，或从您组织的分析设置中导出 [支出报告](https://support.claude.com/en/articles/12883420-view-usage-analytics-for-team-and-enterprise-plans)，其中列出了每个用户和每个模型的令牌使用情况和估计的使用额度支出。
...
<Warning>
  启用了 [Zero Data Retention#/page/zero-data-retention 的组织无法使用贡献指标。分析仪表板将仅显示使用指标。
</Warning>
...
* [使用 OpenTelemetry 进行监控#/page/monitoring-usage：将实时指标和事件导出到您的可观测性堆栈
* [有效管理成本#/page/costs：设置支出限制并优化令牌使用
* [权限#/page/permissions：配置角色和权限
