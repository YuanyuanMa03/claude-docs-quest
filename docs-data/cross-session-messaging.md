...
* **Your other local sessions**: Claude Code sessions running on the same machine, including [background sessions#/page/agent-view. A session appears only when it binds an [inbox socket](#the-sessions-inbox-socket).
